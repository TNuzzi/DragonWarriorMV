...
Sprite_Enemy.prototype.update = function() {
    ...
    if (this._battler.enemyId() === 40) {
        // Use to move enemy down
        this.y += 70;
        this.x -= 55;
...
Sprite_Enemy.prototype.startRedBlink = function() {
    this._effectDuration = 32;
};
...
Sprite_Enemy.prototype.isRedBlinking = function() {
    return this._effectDuration !== 0
};

Sprite_Enemy.prototype.updateRedBlink = function() {
    if (this._effectDuration === 0) {
        this.revertToNormal();
        return;
    }

    var alpha = this._effectDuration % 4 === 0 ? 255 : 0;
    this.setBlendColor([216, 40, 0, alpha]);
...
Sprite_Enemy.prototype.runsAway = function() {
    this.opacity = 0;
};
...
Spriteset_Battle.prototype.locateBattleback = function() {
    var width = this._battleField.width + 70;
    var height = this._battleField.height + 70;
    ...
    sprite1.width = Graphics.width;
    sprite1.height = Graphics.height;
    sprite1.x = 0;
    sprite1.y = 0;

    sprite2.width = width;
    sprite2.height = height;
    sprite2.x = Math.floor((Graphics.width - imageWidth) / 2);
    sprite2.y = Math.floor((Graphics.height - imageHeight) / 2);
};
...
Spriteset_Battle.prototype.defaultBattleback2Name = function() {
    ...
    if ($gameSwitches.value(10)) {
        return 'dw1_battleback_dark_cave';
    } else if ($gameSwitches.value(65)) { // For special enemy use dark battleback
        return 'dw1_battleback_dark';
    } else {
        return 'dw1_battleback';
    }
};
